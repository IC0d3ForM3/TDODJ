...
exports.saveTresherForUser = exports.createTresherForUser = exports.checkTresherAccessibleByIdForUser = exports.fetchTreshersByIds = exports.checkUserIsAdminByGuid = exports.fetchAllTreshersWithUsername = exports.fetchTresherLibraryByUserGuid = exports.fetchTreshersByUserGuid = exports.deleteTresherForUser = void 0;
const tresherRepository_1 = require("../repositories/tresherRepository");
const deleteTresherForUser = async (id, userguid) => {
    return await (0, tresherRepository_1.deleteTresherForUser)(id, userguid);
};
...
const createTresherForUser = async (userguid, payload) => {
    return await (0, tresherRepository_2.insertTresherForUser)(userguid, payload);
};
exports.createTresherForUser = createTresherForUser;
const saveTresherForUser = async (id, userguid, payload) => {
    return await (0, tresherRepository_2.updateTresherForUser)(id, userguid, payload);
};
